...
take a prime number p and mark all its multiples as non-prime - main concept of sieve

class Solution {
  public:
    // time n * log ( log n) // mathematically proven no explanation + o( 2 * n)
    // space O(n) // for storing prime numbers  
